...
function fallbackSM2() {
	...
	script.src = "/static/themes/dashboard/js/sm2/soundmanager2.js";
	script.onload = function() {
		...
		soundManager.url = '/static/themes/dashboard/js/sm2/'; // path to directory containing SoundManager2 .SWF file
		...
		soundManager.onload = function() {
			...
			sm2sound = soundManager.createSound({
				...
				volume: 100,
				onstop : function() { 
					$("body").trigger("stopmusic");
					audioData.pause = true; 
				},
				onplay : function() { 
					$("body").trigger("playmusic");
					audioData.pause = false;
				}
			});
