...
{$THEMESECTION.HTMLBEGIN}
	<head>
		...
		<link rel="stylesheet/less" type="text/css" href="{$SITEURL}static/themes/default/css/style.less" />
		...
		<link rel="icon"			href="{$SITEURL}favicon_still.ico"	type="image/x-icon" />
	...
	<body data-page="login">
		{$THEMESECTION.BODYBEGIN}
		{$THEMESECTION.CONTAINERBEGIN}